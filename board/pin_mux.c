...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t i3c0_sda_config = {/* Internal pull-up resistor is enabled */
                                                     kPORT_PullUp,
    ...
    PORT_SetPinConfig(I3C0_SDA_PORT, I3C0_SDA_PIN, &i3c0_sda_config);

    const port_pin_config_t i3c0_scl_config = {/* Internal pull-up resistor is enabled */
                                                     kPORT_PullUp,
                                                     /* Low internal pull resistor value is selected. */
                                                     kPORT_LowPullResistor,
                                                     /* Fast slew rate is configured */
    ...
    PORT_SetPinConfig(I3C0_SCL_PORT, I3C0_SCL_PIN, &i3c0_scl_config);

    const port_pin_config_t i3c1_sda_config = {/* Internal pull-up resistor is enabled */
                                                     kPORT_PullUp,
                                                     /* High internal pull resistor value is selected. */
                                                     kPORT_HighPullResistor,
                                                     /* Fast slew rate is configured */
                                                     ...
                                                     kPORT_UnlockRegister};
    /* PORT1_16 (pin F6) is configured as I3C1_SDA */
    PORT_SetPinConfig(I3C1_SDA_PORT, I3C1_SDA_PIN, &i3c1_sda_config);

    const port_pin_config_t i3c1_scl_config = {/* Internal pull-up resistor is enabled */
                                                     kPORT_PullUp,
                                                     /* Low internal pull resistor value is selected. */
                                                     kPORT_LowPullResistor,
                                                     /* Fast slew rate is configured */
                                                     ...
                                                     kPORT_UnlockRegister};
    /* PORT1_17 (pin F4) is configured as I3C1_SCL */
    PORT_SetPinConfig(I3C1_SCL_PORT, I3C1_SCL_PIN, &i3c1_scl_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
