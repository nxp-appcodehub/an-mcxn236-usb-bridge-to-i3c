 ...
 * Definitions
 ******************************************************************************/
extern gpio_pin_config_t gpio_test_h;
extern gpio_pin_config_t gpio_test_l;

#define T_DELAY_RS       1  //enable delay between T bit and repeated start
...
const port_pin_config_t g_i3c_scl_gpio_config = {   /* Internal pull-up/down resistor is disabled */
													kPORT_PullDisable,
...
const port_pin_config_t g_i3c_scl_config = {   /* Internal pull-up resistor is enabled */
												kPORT_PullUp,
												/* Low internal pull resistor value is selected. */
												kPORT_LowPullResistor,
												/* Fast slew rate is configured */
...
const port_pin_config_t g_i3c_sda_gpio_config = {   /* Internal pull-up/down resistor is disabled */
													kPORT_PullDisable,
													/* Low internal pull resistor value is selected. */
													kPORT_LowPullResistor,
													/* Fast slew rate is configured */
...
const port_pin_config_t g_i3c_sda_config = {   /* Internal pull-up resistor is enabled */
												 kPORT_PullUp,
                                                                   ...
                                                                   i3c_master_state_machine_param_t *stateParams)
{
    ...
    if (0UL != (stateParams->status & (uint32_t)kI3C_MasterCompleteFlag))
    {
    	...
    	if(base == I3C0)
    	{
            PORT_SetPinConfig(I3C0_SCL_PORT, I3C0_SCL_PIN, &g_i3c_scl_gpio_config);//configure the I3C0_SCL pin as GPIO mode
            GPIO_PinInit(GPIO0, I3C0_SCL_PIN, &gpio_test_l);//make I3C0_SCL pin to low
    	}
    	else if(base == I3C1)
    	{
        ...
        if (handle->remainingBytes < 256U)
        {
            ...
            stateParams->result = I3C_MasterRepeatedStartWithRxSize(base, handle->transfer.busType, handle->transfer.slaveAddress,
